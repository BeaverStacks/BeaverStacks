...
# commented out because Scripts is no longer valid? IDK - Asa
# Scripts
...
# commented out because these cause errors, I know nothing about OAuth and just want to get things running =P - Asa
...
def index(request):
    ...
    print('this is just some text that Asa put here to sidestep an issue with profile tracks')

    # Commented out because... this doesn't seem to work? -AH
    # if not request.user.is_active:
    #     if request.GET.items():

            # Commented out because I know nothing about profile tracks
    ...
    # create some dummy transaction data just to connect jinja2
    dummy_transactions = [
